...
//                }
                    ...
                    if (insertData == true) {
                        ...
                        mednameet.setText("");
                        Toast.makeText(com.example.informatikakesehatan.AddMedInfo.this, "Successfully Insterted!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(com.example.informatikakesehatan.AddMedInfo.this, "Please Fill The Medication Name", Toast.LENGTH_SHORT).show();
                }
...
//                showCalendarView(AddMedInfo.this);
        ...
        quantityLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showAddNoOfPills(com.example.informatikakesehatan.AddMedInfo.this);
        ...
        notesLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showAddNoteDialog(com.example.informatikakesehatan.AddMedInfo.this);
...
//                Toast.makeText(AddMedInfo.this, adapterView.getSelectedItem().toString(), Toast.LENGTH_LONG).show();
                ...
                if (adapterView.getSelectedItem().toString().equals("Per Every n Minutes")) {
                    ...
                    showAddNoOfMinutes(com.example.informatikakesehatan.AddMedInfo.this);
                ...
                if (adapterView.getSelectedItem().toString().equals("Per Every n Hours")) {
                    ...
                    showAddNoOfHours(com.example.informatikakesehatan.AddMedInfo.this);
